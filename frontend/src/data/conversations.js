...
export const conversations = [
  c({ id:'arzt-termin', title:'Beim Arzt — Termin machen', scenario:'doctor_visit', level:'A2',
    desc:'Making a doctor appointment by phone', videoId:'5b-akNoJ6Jk', videoChannel:'Easy German',
  ...
  c({ id:'bahnhof', title:'Am Bahnhof — Fahrkarte kaufen', scenario:'train_station', level:'A1',
    desc:'Buying a train ticket at the counter', videoId:'mFcMbOjHSaQ', videoChannel:'Easy German',
  ...
  c({ id:'wohnung', title:'Wohnungssuche — Besichtigung', scenario:'apartment_search', level:'B1',
    desc:'Calling about an apartment listing', videoId:'jLHNs3N0FiQ', videoChannel:'Learn German with Anja',
  ...
  c({ id:'restaurant', title:'Im Restaurant bestellen', scenario:'restaurant', level:'A1',
    desc:'Ordering food and drinks at a restaurant', videoId:'BN9rRLXujUw', videoChannel:'Deutsch lernen mit der DW',
  ...
  c({ id:'supermarkt', title:'Im Supermarkt einkaufen', scenario:'supermarket', level:'A1',
    desc:'Shopping at the supermarket', videoId:'k7FGBqC9ZWQ', videoChannel:'Easy German',
  ...
  c({ id:'vorstellung', title:'Vorstellungsgespraech', scenario:'job_interview', level:'B2',
    desc:'Job interview — introducing yourself', videoId:'L3m76JdiZoU', videoChannel:'Dein Sprachcoach',
  ...
  c({ id:'auslaenderamt', title:'Beim Auslaenderamt', scenario:'immigration_office', level:'B1',
    desc:'Extending a residence permit', videoId:'G__lu-BQ74s', videoChannel:'Learn German with Anja',
  ...
  c({ id:'bank', title:'Bei der Bank — Konto eroeffnen', scenario:'bank', level:'A2',
    desc:'Opening a bank account', videoId:'3v09PEQAL8o', videoChannel:'Deutsch lernen mit der DW',
  ...
  c({ id:'arzt-praxis', title:'In der Arztpraxis', scenario:'doctor_visit', level:'A2',
    desc:'At the doctor — describing symptoms', videoId:'NkjDQKa68Aw', videoChannel:'Easy German',
  ...
  c({ id:'post', title:'Auf der Post — Paket schicken', scenario:'post_office', level:'A2',
    desc:'Sending a package at the post office', videoId:'JZ3_e0jBsFg', videoChannel:'Deutsch lernen mit der DW',
  ...
  c({ id:'telefon', title:'Am Telefon — Termin vereinbaren', scenario:'phone_call', level:'A2',
    desc:'Making an appointment by phone', videoId:'v4DJqy1m5k8', videoChannel:'Dein Sprachcoach',
  ...
  c({ id:'apotheke', title:'In der Apotheke', scenario:'pharmacy', level:'A2',
    desc:'Buying medicine at the pharmacy', videoId:'rVLsPGKKVWY', videoChannel:'Easy German',
